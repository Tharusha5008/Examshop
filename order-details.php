            ...
            <table class="table table-striped table-hover text-center">
                ...
                <?php
                    ...
                    if(isset($_POST['status'])) {
                        ...
                        $fetch_details = mysqli_query($connection, "select * from orders where id='$booking_no'");
                        ...
                        while($row = mysqli_fetch_assoc($fetch_details)){
                            ...
                            if ($booking_status == 0){ 
                                    ...
                                    elseif ($booking_status == 1) {
                                        $tstatus = "Pre Order is Accepted.";
                                    }
                                    else
                                    {
                                        $tstatus = "Pre Order is Awating.";
                                    }
                            echo '<tr>
                                    <td>' . $name.'</td>
                                    <td>'.$tstatus.'</td>              </tr>';
                    ...
                    {
                    echo "<script>alert('Please enter valid order number');
